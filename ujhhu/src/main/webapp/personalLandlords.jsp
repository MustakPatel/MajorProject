              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4> <%=s.getFirstName()%> <%=s.getLastName()%></h4>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <%=s.getSiteLocation()%> <%=s.getDistrict()%>
                    </div>
                  </div>
                  <hr>
                   <div class="row">
                                      <div class="col-sm-3">
                                        <h6 class="mb-0">Aria</h6>
                                      </div>
                                      <div class="col-sm-9 text-secondary">
                                       <%=s.getAria()%>
                                      </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " target="__blank" href="PersonModifyServlet?id=<%=s.getSiteId()%>">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
